...
These scripts can be used for cross-compilation of Windows Electrum-SCT executables from Linux/Wine.
...
[that script](https://github.com/CryptoLover705/electrum-sct/blob/master/.travis.yml) might help.
