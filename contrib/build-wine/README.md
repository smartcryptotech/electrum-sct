...
These scripts can be used for cross-compilation of Windows Electrum-NYC executables from Linux/Wine.
...
[that script](https://github.com/newyorkcoin/electrum-nyc/blob/master/.travis.yml) might help.
