...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.newyorkcoin.electrum_nyc.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.newyorkcoin.electrum_nyc"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.newyorkcoin.electrum_nyc:externalType",
                '',
                data)
        return extRecord
    ...
    def _nfc_enable_ndef_exchange(self, data):
        ...
        ndef_record = NdefRecord(
                ...
                'org.newyorkcoin.electrum_nyc.kivy', '', data)
