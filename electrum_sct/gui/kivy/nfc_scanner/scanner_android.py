...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.smartcryptotech.electrum_sct.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.smartcryptotech.electrum_sct"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.smartcryptotech.electrum_sct:externalType",
                '',
                data)
        return extRecord
    ...
    def _nfc_enable_ndef_exchange(self, data):
        ...
        ndef_record = NdefRecord(
                ...
                'org.smartcryptotech.electrum_sct.kivy', '', data)
