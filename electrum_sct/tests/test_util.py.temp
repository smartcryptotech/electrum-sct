...
from electrum_nyc.util import (format_satoshis, format_fee_satoshis, parse_URI,
                               is_hash256_str)
...
class TestUtil(SequentialTestCase):
    ...
    def test_parse_URI_address(self):
        ...
        self._do_test_parse_URI('newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ',
    ...
    def test_parse_URI_address_label(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self._do_test_parse_URI('newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ?label=electrum%20test',
    ...
    def test_parse_URI_address_message(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self._do_test_parse_URI('newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ?message=electrum%20test',
    ...
    def test_parse_URI_address_amount(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self._do_test_parse_URI('newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ?amount=0.0003',
    ...
    def test_parse_URI_address_request_url(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self._do_test_parse_URI('newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ?r=http://domain.tld/page?h%3D2a8628fc2fbe',
    ...
    def test_parse_URI_ignore_args(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self._do_test_parse_URI('newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ?test=test',
    ...
    def test_parse_URI_multiple_args(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self._do_test_parse_URI('newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
    ...
    def test_parse_URI_invalid(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self.assertRaises(BaseException, parse_URI, 'notnewyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ')
    ...
    def test_parse_URI_parameter_polution(self):
        ...
        # Converted to NewYorkCoin using `contrib/convertAddress.py` from NewYorkCoin Core.
        self.assertRaises(Exception, parse_URI, 'newyorkcoin:N1LgXEXdjF7G37MPzgwyATN6joULz6LfdQ?amount=0.0003&label=test&amount=30.0')
